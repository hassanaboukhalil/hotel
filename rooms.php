...
<body>
    ...
    <main>
        <section class="section section1">
            ...
            <div class="room-info">
                ...
                <div class="btns">
                    <button onclick="to_sigin()">Book</button>
                    <button><a href="./more_info_room.php?Room=Classic">More Details</a></button>
                </div>
            </div>
        </section>
        <section class="section section2">
            ...
            <div class="room-info">
                ...
                <div class="btns">
                    <button onclick="to_sigin()">Book</button>
                    <button><a href="./more_info_room.php?Room=Superior">More Details</a></button>
                </div>
            </div>
        </section>
        <section class="section section3">
            ...
            <div class="room-info">
                ...
                <div class="btns">
                    <button onclick="to_sigin()">Book</button>
                    <button><a href="./more_info_room.php?Room=Deluxe">More Details</a></button>
                </div>
            </div>
        </section>
    </main>
    ...
    <script src="dist/js/rooms.js"></script>
