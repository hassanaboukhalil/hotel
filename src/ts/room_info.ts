let classic_room_images : string[] = ["images/rooms/classic_room_images/classic_room1.png","images/rooms/classic_room_images/balcony.png","images/rooms/classic_room_images/toilet.png"]
let superior_room_images : string[] = ["images/rooms/superior_room_images/superior_room1.png","images/rooms/superior_room_images/balcony.png","images/rooms/superior_room_images/toilet.png"]
let deluxe_room_images : string[] = ["images/rooms/deluxe_room_images/deluxe_room1.png","images/rooms/deluxe_room_images/balcony.png","images/rooms/deluxe_room_images/toilet.png"]

let classic_room_advantages : string[] = ["Free wifi","Electronic door locks","49\" Smart TV","Iron and ironing board","Air conditioning","24-hour room service","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum"]
let superior_room_advantages : string[] = ["Free wifi","Electronic door locks","49\" Smart TV","Iron and ironing board","Air conditioning","24-hour room service","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum"]
let deluxe_room_advantages : string[] = ["Free wifi","Electronic door locks","49\" Smart TV","Iron and ironing board","Air conditioning","24-hour room service","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum","Lorem ipsum"]


let slider_section = <HTMLElement>document.getElementById("header_section");
let circles_array = <HTMLCollection>document.getElementsByClassName("circle")

let room_type = document.getElementById("title")?.innerHTML;
let r = room_type?.split(" ",1);
room_type = r[0];
let slider_array : any;
...
function slider_fnc(sliderNb : number, slider_array : any){
    sliderInterval = setInterval(function(){
        if(sliderNb == 3)sliderNb = 0;
        slider_section.style.backgroundImage = `url(${slider_array[sliderNb]})`
        circlee = <HTMLElement>circles_array[sliderNb]
        circlee.style.fill = circle_firstcolor;
        for(let i = 0 ; i < circles_array.length ; i++){
            if(i == sliderNb)continue
            circlee = <HTMLElement>circles_array[i]
...
function change_imge(cir : any){
    clearInterval(sliderInterval);
    let c : any = cir.id;
    c = c.slice(1)
    c = parseInt(c);
    slider_section.style.backgroundImage = `url(${slider_array[c]})`
    circlee = <HTMLElement>circles_array[c]
    circlee.style.fill = circle_firstcolor;
    for(let i = 0 ; i < circles_array.length ; i++){
        if(i == c)continue
        circlee = <HTMLElement>circles_array[i]
