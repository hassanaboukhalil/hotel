...
<head>
    ...
    <link rel="stylesheet" href="./dist/css/user-index.css">
...
<body>
    ...
    <header class="section" id="header_section">
        <nav class="navbar">
            ...
            <ul class="menu">
                ...
                <li>
                    <button class="book_btn" onclick="open_book_rm_dg()"><a>Book a Room</a></button>
                </li>
            </ul>
        ...
        <div class="circles_group">
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c0" onclick="change_img(this)" cx="18" cy="18" r="18" fill="black" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c1" onclick="change_img(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c2" onclick="change_img(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c3" onclick="change_img(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c4" onclick="change_img(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
        </div>
        <img src="./images/hotel_img1.png" alt="" id="header_img">
    </header>
    <!-- // End of header // -->
    <!-- ///////// -->
    <!-- ///////// -->
    ...
    <!-- // Main // -->
    <main>
        <section class="section section1" id="1">
            ...
            <button class="btn"><a target="_blank" href="https://www.google.com/maps/dir//Al+Sufouh+1,+Al+Sufouh+-+Dubai+-+United+Arab+Emirates/@25.1182645,55.1494815,13z/data=!3m1!4b1!4m8!4m7!1m0!1m5!1m1!1s0x3e5f6b0ef1b8343f:0x27a64a391cbcc373!2m2!1d55.1845012!2d25.1181909">view on map</a></button>
        </section>
        <!-- // -->
        <section class="section section2">
            <div class="texts">
                ...
                <div>
                    <p class="body_txt">Lorem ipsum dolor sit amet consectetur. Tortor senectus tincidunt sit magna sem est morbi. Turpis pellentesque adipiscing sagittis et nisl sodales sem sagittis lorem. Non at eu nec sit. Id sagittis cras commodo consectetur ante nulla. Non at eu nec sit.</p>
                    <br>
                    <button class="btn" onclick="open_book_rm_dg()">book a room</button>
                </div>
            </div>
        ...
        <section class="section section3">
            <div class="texts">
                ...
                <p class="body_txt">Lorem ipsum dolor sit amet consectetur. Tortor senectus tincidunt sit magna sem est morbi. Turpis pellentesque adipiscing sagittis et nisl sodales sem sagittis lorem. Id sagittis cras commodo consectetur ante nulla. Venenatis pretium ultrices sit pulvinar sed tempor eu dui tincidunt.</p>
            </div>
            <div class="image1"></div>
        </section>
        <!-- // -->
        <section class="section section4">
            <div class="texts">
                <p class="title">Luxury & Wellness</p>
                <p class="body_txt">Lorem ipsum dolor sit amet consectetur. Tortor senectus tincidunt sit magna sem est morbi. Turpis pellentesque adipiscing sagittis et nisl sodales sem sagittis lorem. Id sagittis cras commodo consectetur ante nulla. Venenatis pretium ultrices sit pulvinar sed tempor eu dui tincidunt.</p>
            </div>
            <div class="image1"></div>
        </section>
