...
<head>
    ...
    <link rel="stylesheet" href="dist/css/user-rooms.css">
...
<body>
    ...
    <main>
        ...
        ?>
        <!-- ///// end of reservation template /////// -->
        <!--  -->
        <section class="section section1">
            <div class="img"></div>
            <div class="room-info">
                <p class="title">Classic Room</p>
                <p class="g-nb">Guests : 2 people</p>
                <p class="desciption">Lorem ipsum dolor sit amet consectetur. Faucibus sit sodales mauris elementum gravida.</p>
                <div class="btns">
                    <button onclick="open_book_rm_dg()">Book</button>
                    <button onclick="location.replace('./user_more_info_room.php?Room=Classic')"><a href="./user_more_info_room.php?Room=Classic">More Details</a></button>
                </div>
            </div>
        </section>
        <section class="section section2">
            <div class="img"></div>
            <div class="room-info">
                <p class="title">Superior Room</p>
                <p class="g-nb">Guests : Up  to 3 people</p>
                <p class="desciption">Lorem ipsum dolor sit amet consectetur. Faucibus sit sodales mauris elementum gravida.</p>
                <div class="btns">
                    <button onclick="open_book_rm_dg('Superior')">Book</button>
                    <button onclick="location.replace('./user_more_info_room.php?Room=Superior')"><a href="./user_more_info_room.php?Room=Superior">More Details</a></button>
                </div>
            </div>
        </section>
        <section class="section section3">
            <div class="img"></div>
            <div class="room-info">
                <p class="title">Deluxe Room</p>
                <p class="g-nb">Guests : Up to 4 people</p>
                <p class="desciption">Lorem ipsum dolor sit amet consectetur. Faucibus sit sodales mauris elementum gravida.</p>
                <div class="btns">
                    <button onclick="open_book_rm_dg('Deluxe')">Book</button>
                    <button onclick="location.replace('./user_more_info_room.php?Room=Deluxe')"><a href="./user_more_info_room.php?Room=Deluxe">More Details</a></button>
                </div>
            </div>
        </section>
    </main>
