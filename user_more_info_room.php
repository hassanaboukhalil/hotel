...
<head>
    ...
    <link rel="stylesheet" href="./dist/css/user-more-info-room.css">
...
<body>
    <!-- // -->
    <img style="display: none;" src="./images/rooms/classic_room_images/balcony.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/classic_room_images/classic_room1.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/classic_room_images/toilet.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/superior_room_images/balcony.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/superior_room_images/superior_room1.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/superior_room_images/toilet.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/deluxe_room_images/balcony.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/deluxe_room_images/deluxe_room1.png" alt="" width="0" height="0">
    <img style="display: none;" src="./images/rooms/deluxe_room_images/toilet.png" alt="" width="0" height="0">
    <!-- // -->
    <!-- // -->
    <header class="section" id="header_section">
        ...
        <div class="circles_group">
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c0" onclick="change_imge(this)" cx="18" cy="18" r="18" fill="black" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c1" onclick="change_imge(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
            <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle class="circle" id="c2" onclick="change_imge(this)" cx="18" cy="18" r="18" fill="#706F6F" />
            </svg>
        </div>
    </header>
    <!-- // End of header // -->
    ...
    <!-- // Main // -->
    <main>
        <section class="section1 dscrpn-section">
            <div class="room_info dscrpn-div">
                <p class="title" id="title"><?php echo $_GET["Room"] ?> Room</p>
                <p class="body_txt" id="body_txt">
        ...
        <section class="advantages_section">
            <div class="room_advantages">
                <p class="title">Room Amenities</p>
                <ul id="advantages_menu">
                    <!-- <li>Free wifi</li>
    ...
    <script src="dist/js/room_info.js"></script>
