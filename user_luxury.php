...
<head>
    ...
    <link rel="stylesheet" href="./dist/css/user-luxury.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
    <link rel="stylesheet" type="text/css" href="https://npmcdn.com/flatpickr/dist/themes/material_blue.css">
    <title>Luxury and Wellness</title>
</head>
<body>
    <!-- // header and aside // -->
    <header class="section dscrpn-section" id="header_section">
        ...
        <div class="dscrpn-div">
            <p class="title">Luxury and Wellness</p>
    ...
    <main>
        <section class="section section1">
            <div class="texts">
                <p class="title">Gym</p>
                <p class="body_txt">Gym Lorem ipsum dolor sit amet consectetur. Hendrerit ac at volutpat cursus elit convallis proin. Purus adipiscing enim montes fermentum nunc arcu nulla luctus. Donec massa urna fermentum auctor vel id arcu. Purus adipiscing enim montes fermentum nunc arcu nulla luctus.</p>
            </div>
        ...
        <section class="section section2">
            <div class="texts">
                ...
                <p class="body_txt">Pools Lorem ipsum dolor sit amet consectetur. Hendrerit ac at volutpat cursus elit convallis proin. Purus adipiscing enim montes fermentum nunc arcu nulla luctus. Donec massa urna fermentum auctor vel id arcu. Purus adipiscing enim montes fermentum nunc arcu nulla luctus.</p>
            </div>
            <div class="image1"></div>
        </section>
        <!-- // -->
        <section class="section section3">
            <div class="texts">
                ...
                <p class="body_txt">Basketball Lorem ipsum dolor sit amet consectetur. Hendrerit ac at volutpat cursus elit convallis proin. Purus adipiscing enim montes fermentum nunc arcu nulla luctus. Donec massa urna fermentum auctor vel id arcu. Purus adipiscing enim montes fermentum nunc arcu nulla luctus.</p>
            </div>
            <div class="image1"></div>
        </section>
        <!-- // -->
        <section class="section section4">
            <div class="texts">
                ...
                <p class="body_txt">Football Lorem ipsum dolor sit amet consectetur. Hendrerit ac at volutpat cursus elit convallis proin. Purus adipiscing enim montes fermentum nunc arcu nulla luctus. Donec massa urna fermentum auctor vel id arcu. Purus adipiscing enim montes fermentum nunc arcu nulla luctus.</p>
            </div>
            <div class="image1"></div>
        </section>
        <!-- // -->
        <section class="section section5">
            <div class="texts">
                ...
                <p class="body_txt">Tennis Lorem ipsum dolor sit amet consectetur. Hendrerit ac at volutpat cursus elit convallis proin. Purus adipiscing enim montes fermentum nunc arcu nulla luctus. Donec massa urna fermentum auctor vel id arcu. Purus adipiscing enim montes fermentum nunc arcu nulla luctus.</p>
            </div>
            <div class="image1"></div>
        </section>
    </main>
    ...
    <script src="dist/js/common/users_pages.js"></script></body>
